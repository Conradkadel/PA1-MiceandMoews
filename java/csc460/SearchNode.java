...
public class SearchNode implements Comparable<SearchNode> {
     ...
     * @param pathCoords The coordinates of each path that led to the state.
     * @param cost The cost of the path that led to the state.
     * @param priority The priority of this node in the search queue; 
     ...
     * @param priority The priority of this node in the search queue; 
     *                 lower value = higher priority.
     * @param id A unique identifier for this node to break priority ties.
     */
    public SearchNode(SearchState state, ArrayList<String> pathActions,
            HashSet<SearchState> pathStates, 
    ...
    /**
     * Compares two SearchNodes based on their priority. Breaks ties using
     * their unique IDs.
     */
    @Override
